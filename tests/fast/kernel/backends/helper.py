...
def make_scaled_mm_inputs(
    ...
    if packed_e2m1:
        ...
        aq, sa, _, _ = quantize_operand(a, -1, format.a_format, scale_config)
        bq, sb, _, _ = quantize_operand(b, -2, format.b_format, scale_config)
