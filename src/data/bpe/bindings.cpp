...
PYBIND11_MODULE(_bpe_engine, m) {
    ...
    py::class_<BpeEngine>(m, "BpeEngine")
        ...
        .def("feed", &BpeEngine::feed, py::arg("chunks"), py::arg("vocab"))
        .def("replay_merges", &BpeEngine::replay_merges,
             py::arg("merges"),
             py::arg("progress_callback") = py::none(),
             py::arg("progress_every") = 1000)
        .def("train", &BpeEngine::train,
        ...
        .def("list_pairs", &BpeEngine::list_pairs)
