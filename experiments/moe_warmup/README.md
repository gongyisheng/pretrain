...
Fixed: Qwen3 183M-A51M (64 routed experts, top-8, sigmoid router, aux-loss 1e-3), `seq_len=1024`, `lr=1e-3`, `min_lr=1e-4`, cosine schedule over `max_steps=50000`, Muon optimizer, `batch_size=64`, `grad_accum=4`, `early_stop=10000`. Only `warmup_steps` varies.
