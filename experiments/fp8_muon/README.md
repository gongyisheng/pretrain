...
- **std** — weight/act `fp8_e4m3`, `grad_out` `fp8_e5m2` in both backward GEMMs. The standard mixed-format recipe: e5m2 trades mantissa for exponent range on the wider-dynamic-range gradients.
