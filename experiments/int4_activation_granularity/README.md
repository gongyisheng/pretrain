...
Compare rowwise, 1D, and square 2D activation granularities during INT4 pretraining, holding weight quantization fixed. Unlike the joint weight/activation sweeps, only `training.quantization.scale.act` changes across the W8A8 configs.
...
Five runs: three W8A8 activation granularities, one BF16 baseline, and one W8A16 weight-only control. `w8` and `a8` denote storage width: INT4 codes are stored in `torch.int8`. All quantized runs use fixed 32×32 blockwise INT4 weights, FP32 scales, round-to-nearest-even, unquantized BF16 `grad_out`, and exclude `lm_head`. No activation clipping or Hadamard rotation is enabled.

| Config (`.yaml`) | Weight | Activation block | Forward values per activation scale |
|---|---|---|---|
| `qwen3_51m_bf16` | BF16 | BF16 | — |
| `qwen3_51m_int4_w8a16` | INT4 (32, 32) | BF16 | — |
| `qwen3_51m_int4_w8a8_act_rowwise` | INT4 (32, 32) | rowwise | 512 / 1,536 (projection-dependent) |
| `qwen3_51m_int4_w8a8_act_blockwise1d_32` | INT4 (32, 32) | (1, 32) | 32 |
| `qwen3_51m_int4_w8a8_act_blockwise2d_32` | INT4 (32, 32) | (32, 32) | 1,024 |
...
|---|---|---|---|---|---|
| `bf16` | — | 0 | — | — | Pending |
| `int4_w8a16` | — | — | 0 | — | Pending |
| `int4_w8a8_act_rowwise` | — | — | — | — | Pending |
| `int4_w8a8_act_blockwise1d_32` | — | — | — | — | Pending |
| `int4_w8a8_act_blockwise2d_32` | — | — | — | — | Pending |
