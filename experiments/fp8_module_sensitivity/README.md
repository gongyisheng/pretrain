...
- FP8: `dtype: {weight: fp8_e4m3, act: fp8_e4m3, grad_out: fp8_e5m2}`, `scale.granularity: tensorwise`, `exclude: []`. Only the matched GEMM operands are cast to FP8 on the fly; everything else stays bf16/fp32, hp master weights preserved.
