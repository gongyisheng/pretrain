#!/bin/bash
# Run the int8 W8A8 activation-limit sweep (unbounded, 31, 15, 7, 3) across tensorwise, blockwise-1D 32
# and blockwise-2D 32x32 scaling, vs bf16 and a per-granularity int8 W8A16 reference, at 51M on Qwen3.
...
for granularity in tensorwise blockwise1d_32 blockwise2d_32; do
