...
# fixed. Only granularity changes. Plus a dense is=1536 active-width twin.
set -euo pipefail
cd "$(dirname "$0")/../.."
dir=experiments/moe_granularity

# (is E k) at fixed pool=12288, active=1536 (12.5% sparse); m = 1,2,4,8.
triples=("1536 8 1" "768 16 2" "384 32 4" "192 64 8")
...
configs+=("$dir"/qwen3_51m.yaml)   # dense baseline, same active width (3*d_model)
