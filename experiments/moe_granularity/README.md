...
|--------|:---------:|---:|---:|---:|:-----:|:------:|
| `qwen3-moe-133m-a45m-is1024-e8-k1`  | 1 | 1024 |  8 | 1 | 133M | 45M |
| `qwen3-moe-133m-a45m-is512-e16-k2`  | 2 |  512 | 16 | 2 | 133M | 45M |
| `qwen3-moe-133m-a45m-is256-e32-k4`  | 4 |  256 | 32 | 4 | 133M | 45M |
| `qwen3-moe-133m-a45m-is128-e64-k8`  | 8 |  128 | 64 | 8 | 133M | 45M |
| `qwen3-dense-45m-is1024`            | — | 1024 |  — | — |  45M | 45M |
...
# Single config:
uv run python scripts/train.py --config experiments/moe_granularity/qwen3-moe-133m-a45m-is256-e32-k4.yaml
```
...
|--------|:-:|---:|---:|---:|:--------------:|
| `qwen3-moe-133m-a45m-is1024-e8-k1`  | 1 | 1024 |  8 | 1 | |
| `qwen3-moe-133m-a45m-is512-e16-k2`  | 2 |  512 | 16 | 2 | |
| `qwen3-moe-133m-a45m-is256-e32-k4`  | 4 |  256 | 32 | 4 | |
| `qwen3-moe-133m-a45m-is128-e64-k8`  | 8 |  128 | 64 | 8 | |
| `qwen3-dense-45m-is1024`            | — | 1024 |  — | — | |
