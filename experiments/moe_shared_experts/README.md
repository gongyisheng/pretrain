...
|--------|:------:|:----------:|:-----:|:------:|
| `qwen3-moe-133m-a34m-shared-0-routed-1` | 0 | 1 | 133M | 34M |
| `qwen3-moe-133m-a35m-shared-0-routed-2` | 0 | 2 | 133M | 35M |
| `qwen3-moe-133m-a39m-shared-0-routed-4` | 0 | 4 | 133M | 39M |
| `qwen3-moe-135m-a35m-shared-1-routed-1` | 1 | 1 | 135M | 35M |
| `qwen3-moe-135m-a37m-shared-1-routed-2` | 1 | 2 | 135M | 37M |
| `qwen3-moe-135m-a40m-shared-1-routed-4` | 1 | 4 | 135M | 40M |
| `qwen3-moe-136m-a37m-shared-2-routed-1` | 2 | 1 | 136M | 37M |
| `qwen3-moe-136m-a39m-shared-2-routed-2` | 2 | 2 | 136M | 39M |
| `qwen3-moe-136m-a42m-shared-2-routed-4` | 2 | 4 | 136M | 42M |
| `qwen3-moe-139m-a40m-shared-4-routed-1` | 4 | 1 | 139M | 40M |
| `qwen3-moe-139m-a42m-shared-4-routed-2` | 4 | 2 | 139M | 42M |
| `qwen3-moe-139m-a45m-shared-4-routed-4` | 4 | 4 | 139M | 45M |
...
- Compare along constant active-param contours (e.g. `shared-0-routed-2` vs `shared-1-routed-1`
  ...
  than routing.
- `shared-0` rows are the pure-routed-MoE baselines (no shared expert).
