...
- The explicit FP4 dtype map uses `fp4_e2m1` for weight, activation, and output gradient. Its scale entries use 16×16 blocks for weights and 1×16 blocks for activations and output gradients, `fp8_e4m3` scales, and global scaling. The experiment then adds rounding, rotation, and layer exclusions.
